...
\TLV
   `BOGUS_USE($rd $rd_valid $rs1 $rs1_valid $funct3 $imm_valid $opcode $rs2 $rs2_valid $imm $is_add $is_addi $is_beq $is_bge $is_bgeu $is_blt $is_bltu $is_bne)
   $reset = *reset;
   ...
   $reg_write_data[31:0] = $is_load ? $ld_data :
                                      $result;
   ...
   *failed = *cyc_cnt > M4_MAX_CYC;
   ...
   m4+rf(32, 32, $reset, $rd_valid, $rd, $reg_write_data, $rs1_valid, $rs1, $src1_value, $rs2_valid, $rs2, $src2_value)
